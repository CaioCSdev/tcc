...
Existem vários programas que simulam essas regiões do espaço, porém poucos tem a amplitude e relacionam diferentes propriedades físicas, em especial a relatividade dessas áreas espefícicas, como o \textbf{grmonty}. Tornando o programa mais performático e lhe fornecendo a capacidade de executar em computadores domésticos com dados e precisão relevantes, seria um grande avanço na pesquisa de buracos negros, facilitando a execução de simulações e dimuindo o tempo de espera por dados.
