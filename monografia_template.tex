...
\begin{center}
    ...
    \vspace{3cm}
    \textbf{\Large{Computação de Alta Performance em Astrofísica}}
...
\begin{tabular}{ll}
  CUDA         & Transformada contínua de Fourier (\emph{Continuous Fourier Transform})\\
  GPU         & Transformada discreta de Fourier (\emph{Discrete Fourier Transform})\\
  GPGPU         & Potencial de interação elétron-íon (\emph{Electron-Ion Interaction Potentials})\\
  HCP         & Tranformada de Fourier de tempo reduzido (\emph{Short-Time Fourier Transform})\\
\end{tabular}
